...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2237204686422260927)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237204993648260927)
,p_plug_template_id=>wwv_flow_imp.id(2237204686422260927)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237205262390260927)
,p_plug_template_id=>wwv_flow_imp.id(2237204686422260927)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237205552605260928)
,p_plug_template_id=>wwv_flow_imp.id(2237204686422260927)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237205878195260928)
,p_plug_template_id=>wwv_flow_imp.id(2237204686422260927)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237206123649260928)
,p_plug_template_id=>wwv_flow_imp.id(2237204686422260927)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237206412288260928)
,p_plug_template_id=>wwv_flow_imp.id(2237204686422260927)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237206745821260928)
,p_plug_template_id=>wwv_flow_imp.id(2237204686422260927)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237207099077260928)
,p_plug_template_id=>wwv_flow_imp.id(2237204686422260927)
,p_name=>'Sub Regions'
