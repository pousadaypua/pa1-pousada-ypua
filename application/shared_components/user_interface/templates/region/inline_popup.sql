...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3340111082022411500)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340111328371411500)
,p_plug_template_id=>wwv_flow_imp.id(3340111082022411500)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340111684739411500)
,p_plug_template_id=>wwv_flow_imp.id(3340111082022411500)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340111928598411500)
,p_plug_template_id=>wwv_flow_imp.id(3340111082022411500)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340112253979411501)
,p_plug_template_id=>wwv_flow_imp.id(3340111082022411500)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340112550887411501)
,p_plug_template_id=>wwv_flow_imp.id(3340111082022411500)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340112836808411501)
,p_plug_template_id=>wwv_flow_imp.id(3340111082022411500)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340113173441411501)
,p_plug_template_id=>wwv_flow_imp.id(3340111082022411500)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340113456499411501)
,p_plug_template_id=>wwv_flow_imp.id(3340111082022411500)
,p_name=>'Sub Regions'
