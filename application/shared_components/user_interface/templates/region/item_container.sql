...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2237212158332260931)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237212406252260931)
,p_plug_template_id=>wwv_flow_imp.id(2237212158332260931)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237212773952260931)
,p_plug_template_id=>wwv_flow_imp.id(2237212158332260931)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237213046941260931)
,p_plug_template_id=>wwv_flow_imp.id(2237212158332260931)
,p_name=>'Button Start'
