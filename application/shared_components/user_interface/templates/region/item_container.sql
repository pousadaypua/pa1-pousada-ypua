...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3340118589002411503)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340118846197411503)
,p_plug_template_id=>wwv_flow_imp.id(3340118589002411503)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340119150924411503)
,p_plug_template_id=>wwv_flow_imp.id(3340118589002411503)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340119483737411503)
,p_plug_template_id=>wwv_flow_imp.id(3340118589002411503)
,p_name=>'Button Start'
