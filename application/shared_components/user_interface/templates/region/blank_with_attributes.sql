...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2236553190875260898)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236553432357260898)
,p_plug_template_id=>wwv_flow_imp.id(2236553190875260898)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236553798087260899)
,p_plug_template_id=>wwv_flow_imp.id(2236553190875260898)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236554018989260899)
,p_plug_template_id=>wwv_flow_imp.id(2236553190875260898)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236554312721260899)
,p_plug_template_id=>wwv_flow_imp.id(2236553190875260898)
,p_name=>'Sub Regions'
