...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3340059626164411480)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340059902664411480)
,p_plug_template_id=>wwv_flow_imp.id(3340059626164411480)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340060278741411480)
,p_plug_template_id=>wwv_flow_imp.id(3340059626164411480)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340060546161411480)
,p_plug_template_id=>wwv_flow_imp.id(3340059626164411480)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340060821055411481)
,p_plug_template_id=>wwv_flow_imp.id(3340059626164411480)
,p_name=>'Sub Regions'
