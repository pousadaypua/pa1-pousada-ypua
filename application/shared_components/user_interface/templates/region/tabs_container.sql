...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3340136050416411510)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340136307673411510)
,p_plug_template_id=>wwv_flow_imp.id(3340136050416411510)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340136644997411510)
,p_plug_template_id=>wwv_flow_imp.id(3340136050416411510)
,p_name=>'Tabs'
