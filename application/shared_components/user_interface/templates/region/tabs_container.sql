...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2237229673797260939)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237229992473260939)
,p_plug_template_id=>wwv_flow_imp.id(2237229673797260939)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237230245958260939)
,p_plug_template_id=>wwv_flow_imp.id(2237229673797260939)
,p_name=>'Tabs'
