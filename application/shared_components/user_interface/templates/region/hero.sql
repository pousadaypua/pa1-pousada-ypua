...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2236586507422260917)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236586851797260917)
,p_plug_template_id=>wwv_flow_imp.id(2236586507422260917)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236587122495260918)
,p_plug_template_id=>wwv_flow_imp.id(2236586507422260917)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236587452690260918)
,p_plug_template_id=>wwv_flow_imp.id(2236586507422260917)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236587772620260918)
,p_plug_template_id=>wwv_flow_imp.id(2236586507422260917)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236588076045260918)
,p_plug_template_id=>wwv_flow_imp.id(2236586507422260917)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
