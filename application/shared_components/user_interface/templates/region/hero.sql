...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3340092951420411493)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340093273113411494)
,p_plug_template_id=>wwv_flow_imp.id(3340092951420411493)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340093571303411494)
,p_plug_template_id=>wwv_flow_imp.id(3340092951420411493)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340093866144411494)
,p_plug_template_id=>wwv_flow_imp.id(3340092951420411493)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340094127612411494)
,p_plug_template_id=>wwv_flow_imp.id(3340092951420411493)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340094475781411494)
,p_plug_template_id=>wwv_flow_imp.id(3340092951420411493)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
