...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3340096477259411495)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340096746987411495)
,p_plug_template_id=>wwv_flow_imp.id(3340096477259411495)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340097025236411495)
,p_plug_template_id=>wwv_flow_imp.id(3340096477259411495)
,p_name=>'Sub Regions'
