...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2236590007044260919)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236590349705260919)
,p_plug_template_id=>wwv_flow_imp.id(2236590007044260919)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236590641846260919)
,p_plug_template_id=>wwv_flow_imp.id(2236590007044260919)
,p_name=>'Sub Regions'
