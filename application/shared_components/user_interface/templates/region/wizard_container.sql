...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2237237378127260942)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237237632391260942)
,p_plug_template_id=>wwv_flow_imp.id(2237237378127260942)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237237935530260943)
,p_plug_template_id=>wwv_flow_imp.id(2237237378127260942)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237238295071260943)
,p_plug_template_id=>wwv_flow_imp.id(2237237378127260942)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237238573356260943)
,p_plug_template_id=>wwv_flow_imp.id(2237237378127260942)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237238876942260943)
,p_plug_template_id=>wwv_flow_imp.id(2237237378127260942)
