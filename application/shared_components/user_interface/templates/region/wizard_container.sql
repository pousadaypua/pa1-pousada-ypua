...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3340143782624411512)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340144047271411513)
,p_plug_template_id=>wwv_flow_imp.id(3340143782624411512)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340144327870411513)
,p_plug_template_id=>wwv_flow_imp.id(3340143782624411512)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340144618515411513)
,p_plug_template_id=>wwv_flow_imp.id(3340143782624411512)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340144978351411513)
,p_plug_template_id=>wwv_flow_imp.id(3340143782624411512)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340145239971411513)
,p_plug_template_id=>wwv_flow_imp.id(3340143782624411512)
