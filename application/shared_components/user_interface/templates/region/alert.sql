...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2236547997291260895)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236548208441260895)
,p_plug_template_id=>wwv_flow_imp.id(2236547997291260895)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236548503349260896)
,p_plug_template_id=>wwv_flow_imp.id(2236547997291260895)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236548849970260896)
,p_plug_template_id=>wwv_flow_imp.id(2236547997291260895)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236549144897260896)
,p_plug_template_id=>wwv_flow_imp.id(2236547997291260895)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236549483480260896)
,p_plug_template_id=>wwv_flow_imp.id(2236547997291260895)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236549735633260897)
,p_plug_template_id=>wwv_flow_imp.id(2236547997291260895)
,p_name=>'Sub Regions'
