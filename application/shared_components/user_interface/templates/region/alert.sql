...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3340054453007411478)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340054798628411478)
,p_plug_template_id=>wwv_flow_imp.id(3340054453007411478)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340055075567411478)
,p_plug_template_id=>wwv_flow_imp.id(3340054453007411478)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340055351318411478)
,p_plug_template_id=>wwv_flow_imp.id(3340054453007411478)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340055673392411478)
,p_plug_template_id=>wwv_flow_imp.id(3340054453007411478)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340055921416411478)
,p_plug_template_id=>wwv_flow_imp.id(3340054453007411478)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340056226070411479)
,p_plug_template_id=>wwv_flow_imp.id(3340054453007411478)
,p_name=>'Sub Regions'
