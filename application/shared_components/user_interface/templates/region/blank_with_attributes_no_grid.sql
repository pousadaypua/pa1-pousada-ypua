...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3340061041664411481)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340061306341411481)
,p_plug_template_id=>wwv_flow_imp.id(3340061041664411481)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340061625923411481)
,p_plug_template_id=>wwv_flow_imp.id(3340061041664411481)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340061991257411481)
,p_plug_template_id=>wwv_flow_imp.id(3340061041664411481)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340062248367411481)
,p_plug_template_id=>wwv_flow_imp.id(3340061041664411481)
,p_name=>'Sub Regions'
