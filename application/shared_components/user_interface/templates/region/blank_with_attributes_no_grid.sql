...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2236554595378260899)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236554819967260899)
,p_plug_template_id=>wwv_flow_imp.id(2236554595378260899)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236555133697260899)
,p_plug_template_id=>wwv_flow_imp.id(2236554595378260899)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236555412282260899)
,p_plug_template_id=>wwv_flow_imp.id(2236554595378260899)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236555754182260900)
,p_plug_template_id=>wwv_flow_imp.id(2236554595378260899)
,p_name=>'Sub Regions'
