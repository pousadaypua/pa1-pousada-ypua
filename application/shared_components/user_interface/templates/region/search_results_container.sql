...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3340123537466411505)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340123881244411505)
,p_plug_template_id=>wwv_flow_imp.id(3340123537466411505)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340124191331411505)
,p_plug_template_id=>wwv_flow_imp.id(3340123537466411505)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340124452867411505)
,p_plug_template_id=>wwv_flow_imp.id(3340123537466411505)
,p_name=>'Sub Regions'
