...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2237217155698260933)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237217486350260933)
,p_plug_template_id=>wwv_flow_imp.id(2237217155698260933)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237217766348260933)
,p_plug_template_id=>wwv_flow_imp.id(2237217155698260933)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237218085775260934)
,p_plug_template_id=>wwv_flow_imp.id(2237217155698260933)
,p_name=>'Sub Regions'
