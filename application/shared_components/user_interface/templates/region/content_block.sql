...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3340088388674411491)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340088651659411492)
,p_plug_template_id=>wwv_flow_imp.id(3340088388674411491)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340088991774411492)
,p_plug_template_id=>wwv_flow_imp.id(3340088388674411491)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340089207188411492)
,p_plug_template_id=>wwv_flow_imp.id(3340088388674411491)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340089559968411492)
,p_plug_template_id=>wwv_flow_imp.id(3340088388674411491)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340089891360411492)
,p_plug_template_id=>wwv_flow_imp.id(3340088388674411491)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340090125604411492)
,p_plug_template_id=>wwv_flow_imp.id(3340088388674411491)
,p_name=>'Sub Regions'
