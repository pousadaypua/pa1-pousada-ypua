...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2236581986175260915)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236582233496260915)
,p_plug_template_id=>wwv_flow_imp.id(2236581986175260915)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236582595897260915)
,p_plug_template_id=>wwv_flow_imp.id(2236581986175260915)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236582823214260915)
,p_plug_template_id=>wwv_flow_imp.id(2236581986175260915)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236583155887260915)
,p_plug_template_id=>wwv_flow_imp.id(2236581986175260915)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236583440205260916)
,p_plug_template_id=>wwv_flow_imp.id(2236581986175260915)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2236583712547260916)
,p_plug_template_id=>wwv_flow_imp.id(2236581986175260915)
,p_name=>'Sub Regions'
