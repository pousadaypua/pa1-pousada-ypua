...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3340116463742411502)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340116770268411502)
,p_plug_template_id=>wwv_flow_imp.id(3340116463742411502)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340117019361411502)
,p_plug_template_id=>wwv_flow_imp.id(3340116463742411502)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340117332314411502)
,p_plug_template_id=>wwv_flow_imp.id(3340116463742411502)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340117672129411503)
,p_plug_template_id=>wwv_flow_imp.id(3340116463742411502)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(3340117935491411503)
,p_plug_template_id=>wwv_flow_imp.id(3340116463742411502)
,p_name=>'Sub Regions'
