...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(2237210010714260930)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237210372850260930)
,p_plug_template_id=>wwv_flow_imp.id(2237210010714260930)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237210616422260930)
,p_plug_template_id=>wwv_flow_imp.id(2237210010714260930)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237210983730260930)
,p_plug_template_id=>wwv_flow_imp.id(2237210010714260930)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237211268042260930)
,p_plug_template_id=>wwv_flow_imp.id(2237210010714260930)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2237211548216260930)
,p_plug_template_id=>wwv_flow_imp.id(2237210010714260930)
,p_name=>'Sub Regions'
