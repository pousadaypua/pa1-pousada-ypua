prompt --application/shared_components/user_interface/lovs/status_manutencao_descricao
begin
--   Manifest
--     STATUS_MANUTENCAO.DESCRICAO
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(2237483443884264182)
,p_lov_name=>'STATUS_MANUTENCAO.DESCRICAO'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
