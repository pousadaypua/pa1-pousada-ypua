prompt --application/shared_components/user_interface/lovs/status_limpeza_descricao
begin
--   Manifest
--     STATUS_LIMPEZA.DESCRICAO
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(2237482771986264181)
,p_lov_name=>'STATUS_LIMPEZA.DESCRICAO'
,p_source_type=>'TABLE'
,p_location=>'LOCAL'
